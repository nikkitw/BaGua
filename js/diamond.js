...
function calc1(){
	...
	if (n_invalid==1){document.getElementById("n_invalid").innerHTML = "　日期輸入錯誤";}
	else {document.getElementById("n_invalid").innerHTML = "";}
	if (t_invalid==1){document.getElementById("t_invalid").innerHTML = "　日期輸入錯誤";}
...
window.onload = function(){ 
	...
	document.getElementById("gain2").value=65;
