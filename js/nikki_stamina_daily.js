...
//0-fixed,1-select(text,value),2-input
	...
	['任務·分享3次',0,6],
	['分享獲得物品',0,6],
	['上線·午餐',1,['周日','週一','週二','週三','週四','週五','週六'],[60,30,30,30,30,30,60]],
	['上線·晚餐',0,60],
	['好友贈送',2,50],
	['聯盟獎勵',1,['5星','4星','3星','2星','1星'],[35,30,25,22,20]],
	['V禮包',1,['V0','V1','V2','V3','V4','V5','V6','V7','V8','V9','V10','V11','V12','V13','V14','V15'],[0,10,10,15,20,25,25,30,35,40,50,50,55,55,60,60]],
	// ['暖心加油站',0,5],
	// ['心悅每日禮包',0,10],
	['簽到/活動',2,0]
];
...
function chgDayMode(val){
	if(val==1) {
		...
		out+='<br>&emsp;從：<button onclick="chgDate(0,-1)">-</button>';
...
function calc(){
	...
	out+=tr(td('有')+td('來源')+(dayMode?td('體力'):dateShow),'style="font-weight:bold;"');
	for(var i in data){
	...
	if(interval>1) {out+=tr(td('')+td(interval+'天體力總計')+td('','colspan="'+interval+'" id="sum_all"'),'style="font-weight:bold;"')}
	out+='</table>';
